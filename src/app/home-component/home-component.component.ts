...
export class HomeComponentComponent {
  ...
  ngOnInit() {
    this.recipe.getRecipes().subscribe((allrecipes: any) => {
      this.recipe.getFavourties().subscribe((fav: any)=>{
        this.recipeList = fav.map((f:any)=>{
           return allrecipes.find((recip:any)=> recip.id == f.foodId)
          })
